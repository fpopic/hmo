...
If you cannot find the answer to your question here, and you have fileToCin
...
Please make sure you have fileToCin this.
...
some other resources you can use:
  ...
  1. fileToCin other [wiki pages](http://code.google.com/p/googletest/w/list),
